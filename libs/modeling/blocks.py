...
from mamba_ssm.modules.vim import Mamba as ViM
from mamba_ssm.modules.dbm import Mamba as DBM
# from mamba_ssm.modules.BiWSSD_ablate_headdim import Mamba as BiWSSD
# from mamba_ssm.modules.BiWSSD_ablate_fusion_type import Mamba as BiWSSD
# from mamba_ssm.modules.BiWSSD_ablate_WSSD_fully_untied import Mamba as BiWSSD
# from mamba_ssm.modules.BiWSSD_ablate_WSSD_tied_proj_untied_ssm import Mamba as BiWSSD
# from mamba_ssm.modules.BiWSSD_ablate_WSSD_untied_proj_tied_ssm import Mamba as BiWSSD
from mamba_ssm.modules.BiWSSD import Mamba as BiWSSD
...
class MaskMambaBlock(nn.Module):
    def __init__(
        ...
        use_mamba_type="biwssd",  # type of mamba to use: 'biwssd' or 'dbm' or 'vim'
    ) -> None:
        super().__init__()
        if use_mamba_type == 'biwssd':
            self.mamba = BiWSSD(n_embd, d_conv=kernel_size, expand=2)
        elif use_mamba_type == 'dbm':
