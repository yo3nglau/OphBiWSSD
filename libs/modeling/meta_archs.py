...
class OphBiWSSD(nn.Module):
    ...
    def decode_offset(self, out_offsets, pred_start_neighbours, pred_end_neighbours, val_loss_flag=False):
    ...
    def losses(
        ...
        decoded_offsets = self.decode_offset(out_offsets, out_start_logits, out_end_logits, val_loss_flag=True)  # bz, stack_T, num_class, 2
